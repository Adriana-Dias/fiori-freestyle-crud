		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Recrutamento",
									"targetURL": "#nsrecrutamento-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nsrecrutamento-display": {
								"semanticObject": "nsrecrutamento",
								"action": "display",
								"description": "Recrutamento de Pessoal",
								"title": "Recrutamento",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ns.recrutamento",
									"url": sap.ui.require.toUrl("ns/recrutamento")
								}
							}
						}
					}
